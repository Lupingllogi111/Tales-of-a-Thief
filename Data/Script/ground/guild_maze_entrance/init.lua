...
function introCutscene()
  ...
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue("I was just thinking about some things.")
  ...
  UI:SetSpeaker(player)
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue('One of them said something about "members that think they are not cut out to be a thief, but still joined".')
  UI:SetSpeaker(partner)
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue("...")
  GAME:WaitFrames(60)
  ...
  UI:SetSpeakerEmotion("Pain")
  UI:WaitShowDialogue("I joined very recently, and I'm still not too used to this.")
  UI:WaitShowDialogue("I'm scared to mess up everything with my clumsiness and hurt the whole guild...")
